    ...
    <div class="uk-container uk-container-center">
        ...
        <main role="main" class="uk-width-medium-3-4 uk-width-large-5-6 uk-width-small-1-1 uk-container-center"
            ...
            <div class="uk-margin-large-top">
                ...
                <div class="uk-width-large-1-1">
                    <input type="text" name="listName" id="listName" style="position: relative;top:-20px; height:30px;"/>
                </div>

                <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="uploadcss" style="text-align: center;"id="titleTable">
                        <tr>
                ...
                <form width="100%" method="post" action="">
                    <div style="height:700px;overflow: auto">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="uploadcss" style="text-align: center;"id="wordTable">
                            <?php
                            for($i=1;$i<=19;$i++){
                                echo"<tr>";
            ...
            <div class="uk-width" style="position: absolute;right:12px; top:630px;width:80px;">
                <button id="cancelDel" onclick="cancelDelete()" hidden class="uk-button-danger" style="width:62px;">Cancel</button>
            </div>
